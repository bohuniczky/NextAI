/**
 * NextAI Enrollment Popup
 * Simple, smart and predictable enrollment form that appears as a popup
 */

// Wait for DOM to be fully loaded
document.addEventListener('DOMContentLoaded', function() {
    console.log('Enrollment popup loaded');
    ...
    if (!document.getElementById('enrollmentModal')) {
        ...
        console.log('Enrollment modal created');
    }
...
/**
 * Set up all event handlers for the enrollment modal
 */
...
/**
 * Create the enrollment modal HTML structure
 */
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="quickEnrollForm" action="#" method="POST">
...
function addModalStyles() {
    ...
    /**
     * Submit the enrollment form with loading simulation
     */
    function submitEnrollmentForm() {
        ...
        setTimeout(() => {
            ...
            closeButton.addEventListener('click', hideEnrollmentModal);
            form.appendChild(closeButton);
            
            // Auto close after delay
            setTimeout(hideEnrollmentModal, 5000);
        }, 1500);
    }
});
